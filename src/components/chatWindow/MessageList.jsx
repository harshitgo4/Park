  ...
  return (
    <div className={`flex flex-row gap-4`}>
      <div
        id="chatWindow"
        ref={messageListRef}
        className={`flex flex-col  mx-auto pb-60 overflow-y-scroll h-screen gap-4 p-2 ${
          previewPdf ? 'w-1/2' : 'w-[100%] lg:w-[70%]'
        } m-auto`}
      >
        <>
          <div className="z-1 md:mb-10 flex flex-row gap-x-4  text-gray-400">
            <Button
              size="sm"
          ...
          >
            <div linkTarget="_blank">
              Hey {userName ? userName.split(' ')[0] : null}! The document you
              uploaded has context in {namspaceData ? namspaceData[0] : null}. I
              will welcome your questions and provide you with answers within
              the context of this document. <br />
        ...
        {messages && messages.length > 0
          ? messages.map((message, index) => {
              ...
              if (message.type === 'apiMessage') {
                className =
                  `self-start rounded-br-3xl ${bg} rounded-tr-3xl rounded-tl-xl w-full`
              } else {
                className =
