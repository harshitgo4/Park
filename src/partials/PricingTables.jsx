      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12">
            ...
            <p className="text-xl text-gray-400" data-aos="fade-up" data-aos-delay="200">Our pricing options are tailored to accommodate a suitable solution for all.</p>
          </div>
            ...
            <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
              ...
              <div className="relative flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up" data-aos-delay="700">
                <div className="mb-4 pb-4 border-b border-gray-700">
                  ...
                  <div className="text-gray-400">Managing research papers, lecture notes, and assignments efficiently.</div>
                </div>
              ...
              <div className="relative flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up" data-aos-delay="600">
                ...
                <div className="mb-4 pb-4 border-b border-gray-700">
                  ...
                  <div className="text-gray-400">Assist document search, summarization, on papers and articles.</div>
                </div>
              ...
              <div className="relative flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up" data-aos-delay="800">
                <div className="mb-4 pb-4 border-b border-gray-700">
                  ...
                  <div className="text-gray-400">Aid in organizing and retrieving documents, contracts, and reports.</div>
                </div>
                <div className="font-medium mb-3">All features of Essential plus:</div>
                <ul className="text-gray-400 -mb-3 grow">
                  <li className="flex items-center mb-3">
