            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right" data-aos-anchor="[data-aos-id-features-home]">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <h3 className="h3 mb-3">Say hello to AI data queries</h3>
                  <p className="text-xl text-gray-400 mb-4">DocuBot automates document management by allowing users to upload, search, extract information, and interact with their documents through natural language conversations, eliminating the need for manual sorting, searching, and analysis.</p>
                  <ul className="flex flex-wrap text-lg text-gray-400 -mx-2 -my-1">
                    ...
                    <li className="flex items-center mx-2 my-1">
                      ...
                      <span>Eliminate mundane tasks</span>
                    </li>
                  </ul>
                  <div className="flex items-start mt-8">
                    <img className="rounded-full shrink-0 mr-4" src={FeatAvatar} width="40" height="40" alt="Features avatar" />
                    <div>
                      <blockquote className="text-gray-400 italic m-0 mb-3">"Going through personal and research documents has never been easier with an assistant".</blockquote>
                      <div className="text-gray-700 font-medium">
                        <cite className="text-gray-200 not-italic">— Raven Simone</cite> - <a className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out" href="#0">Auditor</a>
                      </div>
                    </div>
                  </div>
                </div>
