      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p className="text-xl text-gray-400">Streamline your documents workflow and enhance collaboration for students, researchers, and businesses with our intuitive knowledge-based application.</p>
          </div>
