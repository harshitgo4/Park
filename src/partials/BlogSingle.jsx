...
import NewsImageInner from '../images/news-inner-image.jpg';
import NewsImageSingle from '../images/news-single.jpg';
            ...
            <article>
              ...
              <footer>
                <div className="md:flex md:items-center md:justify-between text-center md:text-left">
                  <div className="text-lg text-gray-400 italic">Originally published at <Link to="https://qiqodocubot.com/" className="text-gray-200">https://qiqodocubot.com/</Link>.</div>
                ...
                <article className="flex flex-col h-full" data-aos="fade-up" data-aos-delay="400">
                  <header>
                    ...
                    <div className="mb-3">
                      <ul className="flex flex-wrap text-xs font-medium -m-1">
                        <li className="m-1">
                          <Link to="#" className="inline-flex text-center text-gray-100 py-1 px-3 rounded-full bg-pink-500 hover:bg-pink-600 transition duration-150 ease-in-out">Testing</Link>
                        </li>
                        <li className="m-1">
                          <Link to="#" className="inline-flex text-center text-gray-100 py-1 px-3 rounded-full bg-teal-500 hover:bg-teal-600 transition duration-150 ease-in-out">Researching on AI</Link>
                        </li>
                      </ul>
                    </div>
                    <h3 className="h4 mb-2">
